...
/* themes/porto/templates/view/blog/block_blog/views-view-fields--blog-block--our-blog-style2.html.twig */
class __TwigTemplate_9bf6658bfd2272dca954b3fe57323360ffaf8f4489cb47dac5ab17998aefa6b6 extends Twig_Template
{
    ...
    <div class=\"recent-posts mt-xl\">
        ...
        if ($this->getAttribute((isset($context["fields"]) ? $context["fields"] : null), "created_1", array())) {
            // line 9
            echo "                    <span class=\"month background-color-secondary\">";
        ...
        if ($this->getAttribute((isset($context["fields"]) ? $context["fields"] : null), "title", array())) {
            // line 13
            echo "                <h4><a class=\"text-light\" href=\"";
        ...
        // line 20
        echo $this->env->getExtension('sandbox')->ensureToStringAllowed($this->env->getExtension('drupal_core')->escapeFilter($this->env, $this->getAttribute($this->getAttribute((isset($context["fields"]) ? $context["fields"] : null), "path", array()), "content", array()), "html", null, true));
        echo "\" class=\"btn btn-secondary mt-md mb-xl\">Read More</a>
        </article>
    </div>
</div>";
    }
    ...
    {
        return "themes/porto/templates/view/blog/block_blog/views-view-fields--blog-block--our-blog-style2.html.twig";
    }
    ...
    <div class=\"recent-posts mt-xl\">
        <article class=\"post\">
            <div class=\"date\">
                ...
                {% endif %}
                {% if fields.created_1 %}
                    <span class=\"month background-color-secondary\">{{ fields.created_1.content }}</span>
                {% endif %}
            </div>
            {% if fields.title %}
                <h4><a class=\"text-light\" href=\"{{ fields.path.content }}\">{{ fields.title.content }}</a></h4>
            {% endif %}
            <div>
                {% if fields.body %}
                    {{ fields.body.content }}
            ...
            <a href=\"{{ fields.path.content }}\" class=\"btn btn-secondary mt-md mb-xl\">Read More</a>
        </article>
    </div>
</div>";
    }
